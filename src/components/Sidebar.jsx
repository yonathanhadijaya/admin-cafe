...
const Sidebar = () => {
    return (
        <div className="m-4 h-[calc(100vh-2rem-2px)] w-20 bg-dark rounded-xl shadow-xl">
            <aside>
                <div className="flex">
                ...
                {/* sidebar buttons */}
                <ul className="flex flex-col p-4 gap-2 text-sm font-semibold text-dark overflow-y-auto scrollbar-thin scrollbar-thumb-slate-400 scrollbar-thumb-rounded-md">
                    <Button
                        href="/"
